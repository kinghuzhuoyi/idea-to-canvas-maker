...
export const mockStrategyVersions: Record<string, StrategyVersion[]> = {
  's1': [
    { id: 'v1', versionNumber: 'v2.1.0', description: '优化信用评分算法，提升准确率', status: 'effective', updatedAt: '2024-12-15 14:30', updatedBy: '张三', publishedAt: '2024-12-15 15:00' },
    { id: 'v2', versionNumber: 'v2.0.0', description: '新增多维度特征支持', status: 'draft', updatedAt: '2024-12-10 10:20', updatedBy: '李四' },
    { id: 'v3', versionNumber: 'v1.5.0', description: '修复边界条件问题', status: 'draft', updatedAt: '2024-12-05 09:15', updatedBy: '王五' },
    { id: 'v4', versionNumber: 'v1.0.0', description: '初始版本发布', status: 'draft', updatedAt: '2024-11-20 16:00', updatedBy: '张三', publishedAt: '2024-11-21 10:00' },
  ],
  's2': [
    { id: 'v5', versionNumber: 'v1.2.0', description: '增加实时风险评估', status: 'grayscale', updatedAt: '2024-12-14 11:00', updatedBy: '李四' },
    { id: 'v6', versionNumber: 'v1.1.0', description: '优化欺诈检测规则', status: 'effective', updatedAt: '2024-12-08 14:30', updatedBy: '张三', publishedAt: '2024-12-08 16:00' },
