  ...
  's1': [
    ...
    { 
      ...
      approvalInfo: {
        ...
        currentNode: '领导审批',
        isOverdue: true,
        estimatedCompleteTime: '2024-12-22 18:00',
        remindCount: 2,
        nodes: [
          { id: '1', name: '发起', status: 'approved', approver: '李四', approvedAt: '2024-12-19 08:05' },
          { id: '2', name: '技术评审', status: 'approved', approver: '王五', approvedAt: '2024-12-19 14:30' },
          { id: '3', name: '领导审批', status: 'current' },
    ...
    { 
      ...
      description: '修复边界条件问题', 
      status: 'draft', 
      updatedAt: '2024-12-05 09:15', 
      updatedBy: '王五',
      createdAt: '2024-12-03 11:00',
      createdBy: '王五',
    },
    { 
      id: 'v4', 
      ...
      createdBy: '张三',
      publishedAt: '2024-11-21 10:00',
    },
    { 
      id: 'v8', 
      versionNumber: 'v1.8.0', 
      description: '优化模型特征工程，增加时序特征', 
      status: 'draft', 
      updatedAt: '2024-12-20 11:30', 
      updatedBy: '赵六',
  ...
  's2': [
    { 
      ...
      grayscaleInfo: {
        ...
        autoScaleRules: [
          { id: '1', type: 'time', trigger: '运行24小时后', targetRatio: 50, enabled: true },
          { id: '2', type: 'metric', trigger: '通过率≥97%且异常率≤0.3%', targetRatio: 100, enabled: true },
        ],
      },
    },
    { 
    ...
    { 
      ...
      description: '早期测试版本', 
      status: 'invalid', 
      updatedAt: '2024-11-10 09:00', 
      updatedBy: '张三',
      createdAt: '2024-11-05 11:00',
      createdBy: '张三',
    },
  ],
};
